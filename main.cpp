...
struct TCB_t {
	...
	StackType_t *const pStack = &bs_stack[STACK_SIZE - 1]; /* Start of the stack */
private:
	...
	StackType_t* pxTopOfStack, TaskFunction_t pxCode, void *const pvParameters)
{
	...
	*pxTopOfStack = (StackType_t)0x00u;    /* R1 */
...
int main()
{
	static uint8_t led5_mask = 0b00100000u;
	...
	startTasks(); // this should never return
